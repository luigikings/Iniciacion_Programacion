...
alumnospromedios = map(lambda alumno: (alumno[0], (sum(alumno[1]) / len(alumno[1]))),calificaciones.items())

alumnosfiltro = filter(lambda alumno: alumno[1] > 6.0, alumnospromedios)



print(list(alumnosfiltro))
