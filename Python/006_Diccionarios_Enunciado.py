...
"""
alumnosEstudiantes = {"Luis":7,"Andrea":7,"Deyby":10}
...
'''
cambiarNota(alumnosEstudiantes,"Luis",9)
mostrarNota(alumnosEstudiantes,"Luis")

cambiarNota(alumnosEstudiantes,"Luasdasdas",9)
mostrarNota(alumnosEstudiantes,"Luis")
'''
"""
...
"""
empleados ={"Luis": 1200, "Andrea":1300,"David":1400}

sumatotalSalarios = reduce(lambda x, y: x + y, empleados.values(), 0)
print(sumatotalSalarios/len(empleados))
